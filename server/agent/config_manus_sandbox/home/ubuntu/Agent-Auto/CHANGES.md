...
## 🔌 Integrasi Cloudflare Workers AI
...
### Models Used
- **Chat Mode**: Llama 3 8B (fast, suitable for chat)
- **Agent Mode**: Llama 3.1 70B (powerful, suitable for reasoning)
